 ...
 */
public abstract class JCSerialDate implements Comparable, 
                                            Serializable, 
                                            MonthConstants {
...
//                if (s.equals(monthNames[i])) {
     ...
     * @return a new date.
     */
    public static JCSerialDate addDays(final int days, final JCSerialDate base) {

        final int serialDayNumber = base.toSerial() + days;
        return JCSerialDate.createInstance(serialDayNumber);
     ...
     * @return a new date.
     */
    public static JCSerialDate addMonths(final int months, 
                                       final JCSerialDate base) {
        ...
        final int dd = Math.min(
            base.getDayOfMonth(), JCSerialDate.lastDayOfMonth(mm, yy)
        );
        return JCSerialDate.createInstance(dd, mm, yy);
     ...
     * @return A new date.
     */
    public static JCSerialDate addYears(final int years, final JCSerialDate base) {
        ...
        final int targetD = Math.min(
            baseD, JCSerialDate.lastDayOfMonth(baseM, targetY)
        );

        return JCSerialDate.createInstance(targetD, baseM, targetY);
     ...
     *         is BEFORE the base date.
     */
    public static JCSerialDate getPreviousDayOfWeek(final int targetWeekday, 
                                                  final JCSerialDate base) {

        // check arguments...
        if (!JCSerialDate.isValidWeekdayCode(targetWeekday)) {
            throw new IllegalArgumentException(
        ...
        return JCSerialDate.addDays(adjust, base);
     ...
     *         and is AFTER the base date.
     */
    public static JCSerialDate getFollowingDayOfWeek(final int targetWeekday, 
                                                   final JCSerialDate base) {
...
//        if (baseDOW > targetWeekday) {  //
     ...
     *         CLOSEST to the base date.
     */
    public static JCSerialDate getNearestDayOfWeek(final int targetDOW,  
                                                 final JCSerialDate base) {

        // check arguments...
        if (!JCSerialDate.isValidWeekdayCode(targetDOW)) {
            throw new IllegalArgumentException(
                "Invalid day-of-the-week code."
            );
        }
...
//        }
     ...
     */
    public JCSerialDate getEndOfCurrentMonth(final JCSerialDate base) {
        final int last = JCSerialDate.lastDayOfMonth(
            base.getMonth(), base.getYYYY()
        );
        return JCSerialDate.createInstance(last, base.getMonth(), base.getYYYY());
    }
    ...
    public static String weekInMonthToString(final int count) {
        ...
        switch (count) {
            case JCSerialDate.FIRST_WEEK_IN_MONTH : return "First";
            case JCSerialDate.SECOND_WEEK_IN_MONTH : return "Second";
            case JCSerialDate.THIRD_WEEK_IN_MONTH : return "Third";
            case JCSerialDate.FOURTH_WEEK_IN_MONTH : return "Fourth";
            case JCSerialDate.LAST_WEEK_IN_MONTH : return "Last";
            default :
    ...
    public static String relativeToString(final int relative) {
        ...
        switch (relative) {
            case JCSerialDate.PRECEDING : return "Preceding";
            case JCSerialDate.NEAREST : return "Nearest";
            case JCSerialDate.FOLLOWING : return "Following";
     ...
     * @param yyyy  the year (in the range 1900 to 9999).
     *
     * @return An instance of {@link JCSerialDate}.
     */
    public static JCSerialDate createInstance(final int day, final int month, 
                                            final int yyyy) {
     ...
     */
    public static JCSerialDate createInstance(final int serial) {
     ...
     * @return a instance of SerialDate.
     */
    public static JCSerialDate createInstance(final java.util.Date date) {
    ...
    public String toString() {
        return getDayOfMonth() + "-" + JCSerialDate.monthCodeToString(getMonth())
                               + "-" + getYYYY();
    }
     ...
     */
    public abstract int compare(JCSerialDate other);
     ...
     */
    public abstract boolean isOn(JCSerialDate other);
     ...
     */
    public abstract boolean isBefore(JCSerialDate other);
     ...
     */
    public abstract boolean isOnOrBefore(JCSerialDate other);
     ...
     *         as the specified SerialDate.
     */
    public abstract boolean isAfter(JCSerialDate other);
     ...
     *         as the specified SerialDate.
     */
    public abstract boolean isOnOrAfter(JCSerialDate other);

    /**
     * Returns <code>true</code> if this {@link JCSerialDate} is within the 
     ...
     * @return A boolean.
     */
    public abstract boolean isInRange(JCSerialDate d1, JCSerialDate d2);
     ...
     *         is BEFORE this date.
     */
    public JCSerialDate getPreviousDayOfWeek(final int targetDOW) {
     ...
     *         and is AFTER this date.
     */
    public JCSerialDate getFollowingDayOfWeek(final int targetDOW) {
     ...
     */
    public JCSerialDate getNearestDayOfWeek(final int targetDOW) {
