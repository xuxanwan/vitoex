...
public class OutputVerifier {
	...
	public static void verify(List output, List expected) {
		...
		if(!expected.equals(output)) {
			...
			throw new LineMismatchException(it1.nextIndex(), it1.previous().toString(),
	...
	public static void verifyIgnoreOrder(List output, Object[] expected) {
		...
		if(!(expected instanceof String[])) throw new RuntimeException(
