...
/**
 * Intercepted from Clean Code. Author's junit test class for SerialDate, with
 * greater test coverage.
 * 
 * Some amendments by vito.
 * 
 * @author vito
 * 
 */
public class BobsSerialDateTest extends TestCase {
	...
	public void testStringToWeekdayCode() throws Exception {
		...
		if (Locale.getDefault().toString().equals("zh_CN")) {
			assertEquals(MONDAY, stringToWeekdayCode("星期一"));
			assertEquals(TUESDAY, stringToWeekdayCode("星期二"));
			assertEquals(WEDNESDAY, stringToWeekdayCode("星期三"));
			assertEquals(THURSDAY, stringToWeekdayCode("星期四"));
			assertEquals(FRIDAY, stringToWeekdayCode("星期五"));
			assertEquals(SATURDAY, stringToWeekdayCode("星期六"));
			assertEquals(SUNDAY, stringToWeekdayCode("星期日"));
	...
	public void testWeekdayCodeToString() throws Exception {
		if(Locale.getDefault().toString().equals("en_US")){
			...
			assertEquals("星期日", weekdayCodeToString(SUNDAY));
			assertEquals("星期一", weekdayCodeToString(MONDAY));
			assertEquals("星期二", weekdayCodeToString(TUESDAY));
			assertEquals("星期三", weekdayCodeToString(WEDNESDAY));
			assertEquals("星期四", weekdayCodeToString(THURSDAY));
			assertEquals("星期五", weekdayCodeToString(FRIDAY));
			assertEquals("星期六", weekdayCodeToString(SATURDAY));
		}
	...
	public void testMonthCodeToString() throws Exception {
		if(Locale.getDefault().toString().equals("en_US")){
			...
			assertEquals("一月", monthCodeToString(JANUARY));
			assertEquals("二月", monthCodeToString(FEBRUARY));
			assertEquals("三月", monthCodeToString(MARCH));
			assertEquals("四月", monthCodeToString(APRIL));
			assertEquals("五月", monthCodeToString(MAY));
			assertEquals("六月", monthCodeToString(JUNE));
			assertEquals("七月", monthCodeToString(JULY));
			assertEquals("八月", monthCodeToString(AUGUST));
			assertEquals("九月", monthCodeToString(SEPTEMBER));
			assertEquals("十月", monthCodeToString(OCTOBER));
			assertEquals("十一月", monthCodeToString(NOVEMBER));
			assertEquals("十二月", monthCodeToString(DECEMBER));			
		}		
	...
	public void testGetPreviousDayOfWeek() throws Exception {
		assertEquals(d(24, FEBRUARY, 2006), getPreviousDayOfWeek(FRIDAY, d(1,
				MARCH, 2006)));
		assertEquals(d(22, FEBRUARY, 2006), getPreviousDayOfWeek(WEDNESDAY, d(
				1, MARCH, 2006)));
		assertEquals(d(29, FEBRUARY, 2004), getPreviousDayOfWeek(SUNDAY, d(3,
				MARCH, 2004)));
		assertEquals(d(29, DECEMBER, 2004), getPreviousDayOfWeek(WEDNESDAY, d(
				5, JANUARY, 2005)));
	...
	public void testGetFollowingDayOfWeek() throws Exception {
		...
		// d(25, DECEMBER, 2004)));
		assertEquals(d(1, JANUARY, 2005), getFollowingDayOfWeek(SATURDAY, d(26,
				DECEMBER, 2004)));
		assertEquals(d(3, MARCH, 2004), getFollowingDayOfWeek(WEDNESDAY, d(28,
				FEBRUARY, 2004)));
	...
	public void testGetNearestDayOfWeek() throws Exception {
		assertEquals(d(16, APRIL, 2006), getNearestDayOfWeek(SUNDAY, d(16,
				APRIL, 2006)));
		assertEquals(d(16, APRIL, 2006), getNearestDayOfWeek(SUNDAY, d(17,
				APRIL, 2006)));
		assertEquals(d(16, APRIL, 2006), getNearestDayOfWeek(SUNDAY, d(18,
				APRIL, 2006)));
		assertEquals(d(16, APRIL, 2006), getNearestDayOfWeek(SUNDAY, d(19,
				APRIL, 2006)));
		assertEquals(d(23, APRIL, 2006), getNearestDayOfWeek(SUNDAY, d(20,
				APRIL, 2006)));
		assertEquals(d(23, APRIL, 2006), getNearestDayOfWeek(SUNDAY, d(21,
				APRIL, 2006)));
		assertEquals(d(23, APRIL, 2006), getNearestDayOfWeek(SUNDAY, d(22,
				APRIL, 2006)));
		...
		// APRIL, 2006)));
		assertEquals(d(18, APRIL, 2006), getNearestDayOfWeek(TUESDAY, d(18,
				APRIL, 2006)));
		assertEquals(d(18, APRIL, 2006), getNearestDayOfWeek(TUESDAY, d(19,
				APRIL, 2006)));
		assertEquals(d(18, APRIL, 2006), getNearestDayOfWeek(TUESDAY, d(20,
				APRIL, 2006)));
		assertEquals(d(18, APRIL, 2006), getNearestDayOfWeek(TUESDAY, d(21,
				APRIL, 2006)));
		assertEquals(d(25, APRIL, 2006), getNearestDayOfWeek(TUESDAY, d(22,
				APRIL, 2006)));
		...
		// APRIL, 2006)));
		assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(19,
				APRIL, 2006)));
		assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(20,
				APRIL, 2006)));
		assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(21,
				APRIL, 2006)));
		assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(22,
				APRIL, 2006)));
		...
		// APRIL, 2006)));
		assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(THURSDAY, d(20,
				APRIL, 2006)));
		assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(THURSDAY, d(21,
				APRIL, 2006)));
		assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(THURSDAY, d(22,
				APRIL, 2006)));
		...
		// APRIL, 2006)));
		assertEquals(d(21, APRIL, 2006), getNearestDayOfWeek(FRIDAY, d(21,
				APRIL, 2006)));
		assertEquals(d(21, APRIL, 2006), getNearestDayOfWeek(FRIDAY, d(22,
				APRIL, 2006)));
		...
		// APRIL, 2006)));
		assertEquals(d(22, APRIL, 2006), getNearestDayOfWeek(SATURDAY, d(22,
				APRIL, 2006)));
	...
	public void testEndOfCurrentMonth() throws Exception {
		...
		assertEquals(d(31, JANUARY, 2006), d.getEndOfCurrentMonth(d(1, JANUARY,
				2006)));
		assertEquals(d(28, FEBRUARY, 2006), d.getEndOfCurrentMonth(d(1,
				FEBRUARY, 2006)));
		assertEquals(d(31, MARCH, 2006), d.getEndOfCurrentMonth(d(1, MARCH,
				2006)));
		assertEquals(d(30, APRIL, 2006), d.getEndOfCurrentMonth(d(1, APRIL,
				2006)));
		assertEquals(d(31, MAY, 2006), d.getEndOfCurrentMonth(d(1, MAY, 2006)));
		assertEquals(d(30, JUNE, 2006), d
				.getEndOfCurrentMonth(d(1, JUNE, 2006)));
		assertEquals(d(31, JULY, 2006), d
				.getEndOfCurrentMonth(d(1, JULY, 2006)));
		assertEquals(d(31, AUGUST, 2006), d.getEndOfCurrentMonth(d(1, AUGUST,
				2006)));
		assertEquals(d(30, SEPTEMBER, 2006), d.getEndOfCurrentMonth(d(1,
				SEPTEMBER, 2006)));
		assertEquals(d(31, OCTOBER, 2006), d.getEndOfCurrentMonth(d(1, OCTOBER,
				2006)));
		assertEquals(d(30, NOVEMBER, 2006), d.getEndOfCurrentMonth(d(1,
				NOVEMBER, 2006)));
		assertEquals(d(31, DECEMBER, 2006), d.getEndOfCurrentMonth(d(1,
				DECEMBER, 2006)));
		assertEquals(d(29, FEBRUARY, 2008), d.getEndOfCurrentMonth(d(1,
				FEBRUARY, 2008)));
	}
