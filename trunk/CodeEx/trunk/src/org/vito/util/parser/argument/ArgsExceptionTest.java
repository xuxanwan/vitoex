...
public class ArgsExceptionTest extends TestCase {
	...
	public void testMissingStringMessage() throws Exception {
		...
		assertEquals("Could not find string parameter for -x.", e
				.errorMessage());
	}
	...
	public void testInvalidIntegerMessage() throws Exception {
		...
		assertEquals("Argument -x expects an integer but was 'Forty two'.", e
				.errorMessage());
	}
	...
	public void testMissingIntegerMessage() throws Exception {
		...
		assertEquals("Could not find integer parameter for -x.", e
				.errorMessage());
	}
	...
	public void testInvalidDoubleMessage() throws Exception {
		...
		assertEquals("Argument -x expects a double but was 'Forty two'.", e
				.errorMessage());
	}
	...
	public void testMissingDoubleMessage() throws Exception {
		...
		assertEquals("Could not find double parameter for -x.", e
				.errorMessage());
	}
}
